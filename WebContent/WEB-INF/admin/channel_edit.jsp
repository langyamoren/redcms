...
<input type="hidden" name="id" value="<%=channel.getId()%>"/>
  <table class="redtable" width="780" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="69">模型：</td>
      <td width="188">
      <red:modelList selectId="${channel.modelId}"/>      </td>
      <td width="76">父栏目：</td>
      <td width="206">
...
x
高：<input name="picHeight" type="text" id="picHeight" value="<%=channel.getPicHeight()%>" size="10"  style="width:30px;">	  </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="5"  align="left" >
                    <red:temFile temName="index" id="indexTemp" name="indexTemp" selected="<%=channel.getIndexTemp()%>"/>
		      列表模版：<red:temFile temName="list" id="listTemp" name="listTemp" selected="<%=channel.getListTemp()%>"/>
		       内容模版：<red:temFile temName="content" id="contentTemp" name="contentTemp" selected="<%=channel.getContentTemp()%>"/>
      
	  </td>
    </tr>
    <tr>
      <td colspan="6" align="center" valign="middle"><input type="submit" name="Submit" value="修改栏目">
