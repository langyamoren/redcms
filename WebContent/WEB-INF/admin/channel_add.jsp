...
$(document).ready(function(){
	...
	$("#name").formValidator().inputValidator({min:1,onError:"标题不能为空,请确认"});
	$("#path").formValidator().inputValidator({min:1,onError:"路径不能为空,请确认"});
	//$("#content").formValidator().inputValidator({min:1,onError:"内容不能为空,请确认"});
});
</script>
</head>
<body>
<form action="channel" method="post" name="form1" id="form1">
<input type="hidden" name="action" value="saveAdd"/>
  <table class="redtable" width="780" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="69">模型：</td>
      <td width="188">
      <red:modelList selectId="${modelId}"/>      </td>
      <td width="76">父栏目：</td>
...
x
高：<input name="picHeight" type="text" id="picHeight" value="120" size="10"  style="width:30px;">	  </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="5" align="left" >
                    <red:temFile temName="index" id="indexTemp" name="indexTemp" />
		      列表模版：<red:temFile temName="list" id="listTemp" name="listTemp"/>
		       内容模版：<red:temFile temName="content" id="contentTemp" name="contentTemp" />
	  </td>
    </tr>
    <tr>
