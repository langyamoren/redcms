...
<table width="706" border="0" align="center" cellpadding="0" cellspacing="0" class="redtable">
  <tr>
  ...
  <tr>
    ...
    <td colspan="3">
	    <p> 首页：<red:temFile temName="index" id="indexTemp" name="indexTemp" selected="<%=md.getIndexTemp()%>"/>
			      列表：<red:temFile temName="list" id="listTemp" name="listTemp" selected="<%=md.getListTemp()%>"/>
			       内容：<red:temFile temName="content" id="contentTemp" name="contentTemp" selected="<%=md.getContentTemp() %>"/>  
	    </p>      
    </td>
    </tr>
  <tr>
    ...
    <td width="19%" align="right">内容图:</td>
    <td width="40%">宽：
