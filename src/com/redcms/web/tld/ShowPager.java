...
public class ShowPager extends SimpleTagSupport 
{
	...
	public void doTag() throws JspException, IOException 
	{
		...
		sb.append("<a href='html/"+url+"/list_1.html'>第一页</a>&nbsp;&nbsp;");
		if(pageNo>1)
		{
			sb.append("<a href='html/"+url+"/list_"+(pageNo-1)+"'>上一页</a>&nbsp;&nbsp;");
		}else
		{
			sb.append("<a href='html/"+url+"/list_1.html'>上一页</a>&nbsp;&nbsp;");
		}
		
		for(int i=startPage;i<=endPage;i++)
		{
		sb.append("<a href='html/"+url+"/list_"+i+".html'>"+i+"</a>&nbsp;");
		}
		
		if(pageNo<totalPage)
		{
			 sb.append("<a href='html/"+url+"/list_"+(pageNo+1)+".html'>下一页</a>&nbsp;&nbsp;");	
		 
		}else
		{
			sb.append("<a href='html/"+url+"/list_"+totalPage+".html'>下一页</a>&nbsp;&nbsp;");
		}
		sb.append("<a href='html/"+url+"/list_"+totalPage+".html'>最后一页</a>&nbsp;&nbsp;");
