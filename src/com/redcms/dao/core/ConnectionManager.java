...
public abstract class ConnectionManager
{
     ...
     */
     ...
     {  
    		 try
			{
				if(null!=cm.getConnection()&&!cm.getConnection().isClosed()&&!cm.getConnection().getAutoCommit())cm.getConnection().commit();
			} catch (SQLException e)
			{
     ...
     public void rollback()
     {
    		 try
			{
    			if(null!=cm.getConnection()&&!cm.getConnection().isClosed()&&!cm.getConnection().getAutoCommit())
